...
struct GenTaleView: View {
    ...
    private func generatePrompt() -> String {
        ...
        let tailPrompt = "Si alguna de las características mencionadas es inapropiada para el público objetivo, resta coherencia a la estructura del cuento o es imposible de cumplir, reemplazala por algo más adecuado."
