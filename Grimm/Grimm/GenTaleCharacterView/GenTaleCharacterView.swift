        ...
        .sheet(isPresented: $showAddCharacter) {
            LoaderView(isShowing: $showLoader) {
                ScrollView {
                    ...
                    GenTaleTextField(showLoader: $showLoader, text: $newCharacter.name, placeHolder: "Sir Lancelot...", title: "Nombre", genSuggestion: .nameCharacter)
                    ...
                    GenTaleTextField(showLoader: $showLoader, text: $newCharacter.specie, placeHolder: "Elefante, humano...", title: "Especie", genSuggestion: .specieCharacter)
                    GenTaleTextField(showLoader: $showLoader, text: $newCharacter.profession, placeHolder: "Mago, acróbata...", title: "Profesión", genSuggestion: .professionCharacter)
                    GenTaleTextField(showLoader: $showLoader, text: $newCharacter.personality, placeHolder: "Amigable, enojón...", title: "Personalidad", genSuggestion: .personalityCharacter)
                    HStack {
                        Text("Rol")
                            .font(.headline)
                            .padding(EdgeInsets(top: 0, leading: 15, bottom: 0, trailing: 0))
